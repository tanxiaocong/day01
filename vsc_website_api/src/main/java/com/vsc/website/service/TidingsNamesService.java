...
public class TidingsNamesService {
     ...
     */
    public void add(BTidingsAddQo qo, Integer tidingsId,LoginTokens loginTokens) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        if (qo.getTidingsNamesQos().size()!= Constant.ONE){
