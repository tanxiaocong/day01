...
public class MySpringMVCConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(tokenFilter()).addPathPatterns("/backend/**","/commons/**")
                .excludePathPatterns("/backend/users/login**","/commons/attachments/download.do**","/commons/dict/**")
                .excludePathPatterns("/commons/captcha/getCaptcha**","/commons/captcha/verifyCaptcha.do**","/commons/attachments/uploadTmp**")
